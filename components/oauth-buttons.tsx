  ...
  return (
    <div className="w-full">
      <button
        ...
        className={cn(
          "w-full h-11 px-4 rounded-lg font-medium text-sm transition-all duration-200",
      ...
      >
        {loading || isLoading ? (
          ...
          <>
            <Icon />
            <span>Continuar com {config.name}</span>
          </>
        )}
      </button>
    ...
    <div className="space-y-4">
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-card/80 backdrop-blur-sm px-2 text-muted-foreground font-medium">
            Ou continue com
          </span>
        </div>
      </div>
